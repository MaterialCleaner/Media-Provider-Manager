...
class FitsPreferencesTopInsertsCoordinatorLayout @JvmOverloads constructor(
    ...
    private val actionBarSize = context.getDimenByAttr(android.R.attr.actionBarSize).toInt()
    ...
    private fun applyInsets(insets: Rect) {
        setPaddingRelative(
            mPaddingStart, mPaddingTop + insets.top - actionBarSize, mPaddingEnd, mPaddingBottom
        )
    }
}
