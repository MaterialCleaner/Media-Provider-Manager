...
class ViewBoundsCheck {
     ...
     * @param itemView The ViewHolder's itemView.
     ...
     */
    boolean isItemViewWithinBoundFlags(View itemView, @ViewBounds int preferredBoundFlags) {
        final int start = mCallback.getParentStart();
        final int end = mCallback.getParentEnd();
        final int childStart = mCallback.getChildStart(itemView);
        final int childEnd = mCallback.getChildEnd(itemView);
