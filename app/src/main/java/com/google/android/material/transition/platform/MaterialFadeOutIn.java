...
public final class MaterialFadeOutIn extends MaterialVisibility<FadeProvider> {
    ...
    public MaterialFadeOutIn() {
        super(createPrimaryAnimatorProvider(), createPrimaryAnimatorProvider());
    }
