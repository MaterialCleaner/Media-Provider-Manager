...
import static com.google.android.material.transition.platform.FitsScaleTransitionUtils.getLocationOnScreen;
 ...
 * #FitsScaleMaterialContainerTransform(Context, boolean)} constructor. Otherwise, use the default
...
public class FitsScaleMaterialContainerTransform extends Transition {
    ...
    private static final String TAG = FitsScaleMaterialContainerTransform.class.getSimpleName();
    ...
    public FitsScaleMaterialContainerTransform() {
        // Default constructor
    }

    public FitsScaleMaterialContainerTransform(@NonNull Context context, boolean entering) {
     ...
     */
    public static class ProgressThresholds extends MaterialContainerTransform.ProgressThresholds {
